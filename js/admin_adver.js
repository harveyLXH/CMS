...
function adver(type){
    ...
    switch(type){
        ...
        case 2:
            ...
            up.innerHTML = "<input type=\"button\" value=\"上传头部广告690x80\" onclick=\"centerWindow('../config/upfile.php?type=adver&size=690x80','upfile','400','120'); \">";
            fm.adv.value = 2;
            break;
        case 3:
            thumbnail.style.display = 'block';
            up.innerHTML = "<input type=\"button\" value=\"上传侧栏广告270x200\" onclick=\"centerWindow('../config/upfile.php?type=adver&size=270x200','upfile','400','120'); \">";
            fm.adv.value = 3;
            break;
    }
}
