...
<script type="text/javascript" src="../js/admin_login.js">
</script>
</head>
<body>
...
<form id="adminLogin" name="login" method="post" action="?action=login">
	<fieldset>
		...
		<label>账　号：<input type="text" id="admin_user" name="admin_user" class="text"/></label>
		<label>密　码：<input type="password" id="admin_pass" name="admin_pass" class="text"/></label>
		<label>验证码：<input type="text" name="code" class="text"/></label>
		<label class="t">输入胡下图的字符，不区分大小写</label>
