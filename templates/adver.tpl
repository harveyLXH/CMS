...
<form method="get" action="">
	<div id="page">
		...
		<select name="kind" style="backgorund:#fff;border:1px solid #ccc;">
...
<form method="post" name="content">
	...
	<table cellspacing="0" class="left">
		<tr><td>广告类型：
						<input type="radio" name="type" onclick="adver(1)" value="1" checked /> 文字广告
						<input type="radio" name="type" onclick="adver(2)" value="2"/> 头部广告690x80
						<input type="radio" name="type" onclick="adver(3)" value="3"/> 文字广告270x200
			</td></tr>
		...
		<tr id="thumbnail" style="display:none;"><td>广告图片：<input type="text" name="thumbnail" class="text" readonly />
				<span id="up"></span>
...
{if $update}
	<form method="post" name="content">
		...
		<table cellspacing="0" class="left">
			<tr><td>广告类型：
					<input type="radio" name="type" onclick="adver(1)" value="1" {$type1} /> 文字广告
					<input type="radio" name="type" onclick="adver(2)" value="2" {$type2}/> 头部广告690x80
					<input type="radio" name="type" onclick="adver(3)" value="3" {$type3}/> 文字广告270x200
				</td></tr>
			...
			<tr id="thumbnail" {$pic}><td>广告图片：<input type="text" name="thumbnail" value="{$thumbnail}" class="text" readonly />
					<span id="up">{$up}</span>
