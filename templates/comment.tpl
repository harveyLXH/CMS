...
<ol>
    ...
    {if $update}
        <li><a href="comment.php?action=update&id={$id}">修改管理员</a></li>
    {/if}
</ol>
...
<table cellspacing="0">
	...
	<tr>
		...
		<td><a href="comment.php?action=delete&id={@value->id}" onclick="return confirm('你真的要删除评论吗?')?true:false;">删除</a></td>
	</tr>
	{/foreach}
		<tr><td></td><td></td><td></td><td></td><td></td><td><input type="submit" name="send" value="批审" style="cursor:pointer;"/></td></tr>
