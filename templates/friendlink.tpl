...
<div id="friendlink">
    ...
    <form method="post" name="friendlink">
        ...
        <dl>
            <dd>网站类型：<input type="radio" name="type" onclick="link(1)" value="1" checked />文字链接
            ...
            <dd>网站地址：<input type="text" class="text" name="weburl" /> <span class="red">[必填]</span> ( *网站地址不能为空，不得大于100位 )</dd>
            <dd id="logo" style="display:none;">Logo地址：<input type="text" class="text" name="logourl" /> <span class="red">[必填]</span> ( *Logo地址不能为空，不得大于100位 )</dd>
            ...
            <dd><input type="submit" class="submit" name="send" onclick="return checkLink();" value="生成友情链接" /></dd>
        </dl>
    </form>
</div>
{/if}
