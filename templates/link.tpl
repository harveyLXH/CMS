...
{if $show}
<table cellspacing="0">
	<tr><th>编号</th><th>网站名称</th><th>网站地址</th><th>logo地址</th><th>站长名</th><th>类型</th><th>状态</th><th>操作</th></tr>
	{if $AllLink}
...
{if $update}
	<form method="post" name="add">
		...
		<table cellspacing="0" class="left">
			<tr><td>网站类型：<input type="radio" name="type" {$text_type} onclick="link(1)" value="1" checked="checked" /> 文字链接
			...
			<tr><td>站 长 名：<input type="text" value="{$user}" class="text" name="user" value="{$user}" /></td></tr>
