...
<table cellspacing="0">
	...
	<tr>
		...
		<td><a href="manage.php?action=update&id={@value->id}">修改</a> | <a href="manage.php?action=delete&id={@value->id}" onclick="return confirm('你真的要删除管理员吗?')?true:false;">删除</a></td>
	</tr>
	{/foreach}
	{else}
...
{if $update}
    <form method="post" name="update">
        ...
        <table cellspacing="0" class="left">
            <tr><td>用户名：<input type="text" name="admin_user" value="{$admin_user}" class="text" readonly /></td></tr>
