...
<?php } else { ?>
	...
	<form method="post" name="login" action="register.php?action=login">
		...
		<label class="yzm">验证码：<input type="text" name="code" class="text code" />
...
<div id="news">
	...
	<p class="link">
		...
		<?php foreach ($this->_vars['NewTopList'] as $key=>$value) { ?>
			<a href="details.php?id=<?php echo $this->_vars['TopId'];?>" target="_blank"><?php echo $value->title?></a> <?php echo $value->line?>
		<?php } ?>
		<?php } ?>
	</p>
	<ul>
