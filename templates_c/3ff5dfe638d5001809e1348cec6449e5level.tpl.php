...
<table cellspacing="0">
	...
	<tr>
		...
		<td><a href="level.php?action=update&id=<?php echo $value->id?>">修改</a> | <a href="level.php?action=delete&id=<?php echo $value->id?>" onclick="return confirm('你真的要删除等级吗?')?true:false;">删除</a></td>
	</tr>
	<?php } ?>
	<?php } else { ?>
...
<form method="post" name="add">
	<table cellspacing="0" class="left">
		...
		<tr><td><input type="submit" name="send" value="新增等级" onclick="return checkAddForm();" class="submit level" /> [ <a href="<?php echo $this->_vars['prev_url'];?>">返回列表</a> ]</td></tr>
	</table>
</form>
<?php } ?>
...
<?php if ($this->_vars['update']) {?>
	<form method="post" name="add">
		...
		<table cellspacing="0" class="left">
			...
			<tr><td><input type="submit" name="send" value="修改等级" onclick="return checkorm();" class="submit level" /> [ <a href="<?php echo $this->_vars['prev_url'];?>">返回列表</a> ]</td></tr>
