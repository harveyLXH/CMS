...
<table cellspacing="0">
	<tr><th>编号</th><th>权限名称</th><th>描述</th><th>标识</th><th>操作</th></tr>
...
<form method="post" name="add">
	<table cellspacing="0" class="left">
		...
		<tr><td><textarea name="info"></textarea> (*权限描述不得大于200位！</td></tr>
...
<?php if ($this->_vars['update']) {?>
	<form method="post" name="add">
		...
		<table cellspacing="0" class="left">
			...
			<tr><td><textarea name="info"><?php echo $this->_vars['info'];?></textarea> (*权限描述不得大于200位！</td></tr>
			<tr><td><input type="submit" name="send" value="新增权限" onclick="return checkForm();" class="submit level" /> [ <a href="<?php echo $this->_vars['prev_url'];?>">返回列表</a> ]</td></tr>
		</table>
	</form>
<?php } ?>
